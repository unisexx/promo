...
<!-- Owl Carousel -->
<link rel="stylesheet" href="{{ url('nitro_theme/css/owl.carousel.min.css') }}">
<link rel="stylesheet" href="{{ url('nitro_theme/css/owl.theme.default.min.css') }}">

<!-- Theme style  -->
<link rel="stylesheet" href="{{ url('nitro_theme/css/style.css') }}">

<!-- Modernizr JS -->
<script src="{{ url('nitro_theme/js/modernizr-2.6.2.min.js') }}"></script>
<!-- FOR IE9 below -->
<!--[if lt IE 9]>
